        ...
        <div className="p-6 space-y-6">
          ...
          <div className="space-y-3">
            ...
            <div className="bg-agro-gray-light p-4 rounded-lg">
              <div className="flex justify-between items-center">
                <div>
                  <p className="font-bold text-agro-green">Piano Pro</p>
          ...
          <div className="space-y-3">
             ...
             <div className="bg-agro-gray-light p-4 rounded-lg space-y-2">
                <p><span className="font-semibold text-gray-700">Nome:</span> Mario Rossi</p>
                <p><span className="font-semibold text-gray-700">Email:</span> mario.rossi@email.com</p>
